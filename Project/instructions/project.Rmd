...
The dataset may already exist, or you may collect your own data using a survey or by conducting an experiment (this is espcially hard on the block plan).
...
Issues pertaining to the reliability and validity of your data, and appropriateness of the statistical analysis should be discussed here. You could discuss why you make certian descitios in your ansyiss to be an ethical data scientist. 
...
During class you will watch presentations from other teams in your workshop and provide feedback in the form of peer evaluations.
...
The executive summary is worth 50 points and will be evaluated based on whether it follows guidance and whether it's concise but detailed enough.
...
-   `/Initial Meeting`: Your initial meeting document
...
| Total                                                    | 200 pts    |
+==========================================================+============+
| Initial Meeting                                          |  10 pts    |
+----------------------------------------------------------+------------+
| Preliminary Results                                      |  40 pts    |
+----------------------------------------------------------+------------+
| Presentation                                             |  50 pts    |
+----------------------------------------------------------+------------+
| Executive summary                                        |  50 pts    |
+----------------------------------------------------------+------------+
| Reproducibility and organization                         |  25 pts    |
+----------------------------------------------------------+------------+
| Team peer evaluation                                     |  15 pts    |
+----------------------------------------------------------+------------+
| Classmates' evaluation                                   |  10 pts    |
+----------------------------------------------------------+------------+
