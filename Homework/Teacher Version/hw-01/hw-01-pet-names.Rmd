...
-   **Repository:** A Git repository contains all of your project's files and stores each file's revision history.
    ...
    -   All repos associated with this course are housed in the course GitHub organization. The organization is set up such that students can only see repos they have access to, but the course staff (just Professor George) can see all of them.
...
First, we will explore the fundamental building blocks of all of these tools. We did some of this in class together - part this assignment is making sure you can do this on your own. 
...
-   you can log into RStudio Server
...
### Step 2. Go to RStudio Server

Go to [rstudio.server](http://turing:8787/).
...
Make sure to copy the url from the repo associated to this assingment!

```{r new-project-from-git, echo = FALSE, eval = TRUE, fig.show = "hold", out.width = "30%"}
...
```{r new-project-from-git4, echo = FALSE, eval = TRUE, fig.align = "left", out.width = "50%"}
knitr::include_graphics("img/new-project-from-git_mod.png")
```
...
And by others, we mean your Professor, Tyler (your repos in this course are private to you and me, only).
