...
First, we will explore the fundamental building blocks of all of these tools. We did some of this in class together - part this assingment is making sure you can do this on your own. 
...
```{r new-project-from-git4, echo = FALSE, eval = TRUE, fig.align = "left", out.width = "75%"}
