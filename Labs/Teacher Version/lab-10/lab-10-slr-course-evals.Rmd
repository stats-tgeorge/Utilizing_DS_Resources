...
5.  Recreate the scatterplot from Exercise 2, and add the regression line to this plot in orange color.
...
8.  Determine the $R^2$ of the model and interpret it in context of the data. Let me know if nobody in your group has covered this topic in the past. 
