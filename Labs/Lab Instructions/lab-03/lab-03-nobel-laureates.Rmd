---
title: "Lab 03 - Nobel laureate"
author: "Modified by Tyler George"
output: 
  tufte::tufte_html:
    css: ../lab.css
...
-   **Task 1:** Read the Buzzfeed article titled [*These Nobel Prize Winners Show Why Immigration Is So Important For American Science*](https://www.buzzfeednews.com/article/peteraldhous/immigration-and-science)*.* We will replicate this analysis in class so it's crucial that you're familiar with it ahead of time.
...
This is the second time you are working in teams so we're going to make things a little more interesting and let all of you make changes and push those changes to your team repository.
...
### This is **how** you are going to work together on this lab
...
**Others should just watch, not doing anything on their own labs (this includes not even pulling changes!)** until they are instructed to.
If you feel like you won't be able to resist the urge to touch your computer when it's not your turn, I recommend putting your hands in your pockets or sitting on them!
