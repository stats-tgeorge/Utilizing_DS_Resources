...
- Data ethics assignments from [Quantitative Analysis Institute](https://sites.google.com/wellesley.edu/qai-online-resources/home) `r Cite(myBib,"Pattanayak")`
...
- [RStudio Server](https://www.rstudio.com/products/rstudio/download-server/) (new implementation for this course, see `r Citet(myBib,"Cetinkaya-Rundel2018")` for a discussion on infrastructure) 
...
- R packages - primarily within the *tidyverse* 
 - [*ghclass*](https://rundel.github.io/ghclass/) `r Cite(myBib,"Rundel")` for distributing and collecting repositories
