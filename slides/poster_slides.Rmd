...
- Data science ethics assignments from the [Quantitative Analysis Institute](https://sites.google.com/wellesley.edu/qai-online-resources/home) at Wellesley College `r Cite(myBib,"Pattanayak")`
...
- This was used in combination to the data ethics assignments from [Quantitative Analysis Institute](https://sites.google.com/wellesley.edu/qai-online-resources/home) `r Cite(myBib,"Pattanayak")`
- A more thorough approach will be used in the future. Such as adding modules from *Integrating Data Science Ethics Into an Undergraduate Major: A Case Study* by `r Citet(myBib,"Beckman2022")`.

---

# Technologies
- Learning Management System (LMS) - Moodle
- [RStudio Server]("https://www.rstudio.com/products/rstudio/download-server/") (new implementation for this course, see `r Citet(myBib,"Cetinkaya-Rundel2018")` for a discussion on this infrastructure) 
...
- R packages - primarily within the *tidyverse* 
 - *ghclass* `r Citet(myBib,"Rundel")` for distributing and collecting repositories
 
---

# Teaching Pedagogies
- Collaborative learning `r Cite(myBib,"Cary")`
...
- Using tidyverse `r Cite(myBib,"Cetinkaya-Rundel2022")`

- Version control to lead to reproducible work `r Cite(myBib,"Beckman2021")`

---

# Learning the Bare Necessities
- I was new to Git, Github, RStudio Server (Linux), and a handful of the tidyverse packages and functions used.
