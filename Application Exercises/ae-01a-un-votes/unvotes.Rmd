...
# WOW Lots to Look at!
Welcome to RStudio! No worries, you are not expected to know how to use this yet but I want to motivate you to learn it. We will formally learn RStudio in a little bit. If you wish, scroll down to see more code. 

Click the "Knit" button at the top just above this box! Wait for pop-up to generate. 
...
I want you to change which countries are displayed in the plots. Modify the code to show at least 1 different country and click "Knit" again. 
