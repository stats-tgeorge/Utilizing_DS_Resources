...
Refer to either lab 01 or HW 01 if you would like to see step-by-step instructions for cloning a repo into an RStudio project.
...
You may of not finished this whole lab in class. If you have and still have some time left, move on to the remaining exercise below.
If not, you should find a time to meet with your team and complete them after the class.
